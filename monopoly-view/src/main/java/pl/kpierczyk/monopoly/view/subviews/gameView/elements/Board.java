...
public class Board extends JPanel {
    ...
    private ArrayList<JButton> fields = new ArrayList<JButton>();
    ...
    public Board(Settings settings){
        ...
        this.fields.add(new JButton());
        this.fields.get(0).setHorizontalTextPosition(0);
        this.fields.get(0).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/1.png")));
        this.fields.get(0).setIconTextGap(0);
        this.fields.get(0).setMaximumSize(new Dimension(134, 134));
        this.fields.get(0).setMinimumSize(new Dimension(134, 134));
        this.fields.get(0).setOpaque(false);
        this.fields.get(0).setPreferredSize(new Dimension(134, 134));
        this.fields.get(0).setText("");
        this.fields.get(0).setVisible(true);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 10;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        this.add(this.fields.get(0), gbc);



        this.fields.add(new JButton());
        this.fields.get(1).setHorizontalTextPosition(0);
        this.fields.get(1).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/2.png")));
        this.fields.get(1).setIconTextGap(0);
        this.fields.get(1).setMaximumSize(new Dimension(134, 80));
        this.fields.get(1).setMinimumSize(new Dimension(134, 80));
        this.fields.get(1).setPreferredSize(new Dimension(134, 80));
        ...
        this.fields.get(2).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/3.png")));
        ...
        this.fields.get(3).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/4.png")));
        ...
        this.fields.get(4).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/5.png")));
        ...
        this.fields.get(5).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/6.png")));
        ...
        this.fields.get(6).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/7.png")));
        ...
        this.fields.get(7).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/8.png")));
        ...
        this.fields.get(8).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/9.png")));
        ...
        this.fields.get(9).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                        settings.getResolutionSetting().getValue() +
                                                                        "/gameGraphics/fields/10.png")));
        ...
        this.fields.add(new JButton());
        this.fields.get(10).setHideActionText(true);
        this.fields.get(10).setHorizontalTextPosition(0);
        this.fields.get(10).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/11.png")));
        this.fields.get(10).setIconTextGap(0);
        this.fields.get(10).setMaximumSize(new Dimension(134, 134));
        this.fields.get(10).setMinimumSize(new Dimension(134, 134));
        this.fields.get(10).setOpaque(false);
        this.fields.get(10).setPreferredSize(new Dimension(134, 134));
        this.fields.get(10).setText("");
        this.fields.get(10).setVerticalAlignment(0);
        this.fields.get(10).setVerticalTextPosition(0);
        ...
        this.fields.get(11).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/12.png")));
        this.fields.get(11).setIconTextGap(0);
        this.fields.get(11).setMaximumSize(new Dimension(80, 134));
        this.fields.get(11).setMinimumSize(new Dimension(80, 134));
        this.fields.get(11).setPreferredSize(new Dimension(80, 134));
        ...
        this.fields.get(12).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/13.png")));
        ...
        this.fields.get(13).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/14.png")));
        ...
        this.fields.get(14).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/15.png")));
        ...
        this.fields.get(15).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/16.png")));
        ...
        this.fields.get(16).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/17.png")));
        ...
        this.fields.get(17).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/18.png")));
        ...
        this.fields.get(18).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/19.png")));
        ...
        this.fields.get(19).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/20.png")));
        ...
        this.fields.get(20).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/21.png")));
        this.fields.get(20).setIconTextGap(0);
        this.fields.get(20).setMaximumSize(new Dimension(134, 134));
        this.fields.get(20).setMinimumSize(new Dimension(134, 134));
        this.fields.get(20).setOpaque(false);
        this.fields.get(20).setPreferredSize(new Dimension(134, 134));
        ...
        this.fields.get(21).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/22.png")));
        this.fields.get(21).setIconTextGap(0);
        this.fields.get(21).setMaximumSize(new Dimension(134, 80));
        this.fields.get(21).setMinimumSize(new Dimension(134, 80));
        this.fields.get(21).setPreferredSize(new Dimension(134, 80));
        ...
        this.fields.get(22).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/23.png")));
        ...
        this.fields.get(23).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/24.png")));
        ...
        this.fields.get(24).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/25.png")));
        ...
        this.fields.get(25).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/26.png")));
        ...
        this.fields.get(26).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/27.png")));
        ...
        this.fields.get(27).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/28.png")));
        ...
        this.fields.get(28).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/29.png")));
        ...
        this.fields.get(29).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/30.png")));
        ...
        this.fields.get(30).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/31.png")));
        this.fields.get(30).setIconTextGap(0);
        this.fields.get(30).setMaximumSize(new Dimension(134, 134));
        this.fields.get(30).setMinimumSize(new Dimension(134, 134));
        this.fields.get(30).setOpaque(false);
        this.fields.get(30).setPreferredSize(new Dimension(134, 134));
        ...
        this.fields.get(31).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/32.png")));
        this.fields.get(31).setIconTextGap(0);
        this.fields.get(31).setMaximumSize(new Dimension(80, 134));
        this.fields.get(31).setMinimumSize(new Dimension(80, 134));
        this.fields.get(31).setPreferredSize(new Dimension(80, 134));
        ...
        this.fields.get(32).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/33.png")));
        ...
        this.fields.get(33).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/34.png")));
        ...
        this.fields.get(34).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/35.png")));
        ...
        this.fields.get(35).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/36.png")));
        ...
        this.fields.get(36).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/37.png")));
        ...
        this.fields.get(37).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/38.png")));
        ...
        this.fields.get(38).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/39.png")));
        ...
        this.fields.get(39).setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                         settings.getResolutionSetting().getValue() +
                                                                         "/gameGraphics/fields/40.png")));
        ...
        this.centralPart.setIcon(new ImageIcon(getClass().getResource("/lang/" + settings.getLanguage() + "/img/" +
                                                                      settings.getResolutionSetting().getValue() +
                                                                      "/gameGraphics/fields/interior.png")));
